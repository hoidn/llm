...
class TestAiderBridge:
    ...
    async def test_call_aider_tool_ai_code_success(self, MockClientSession, mock_stdio_client, mock_mcp_available, aider_bridge_instance):
    ...
    @patch('src.aider_bridge.bridge.stdio_client', spec=real_stdio_client)
    @patch('src.aider_bridge.bridge.ClientSession', spec=RealClientSession)
    async def test_call_aider_tool_ai_code_failure(self, MockClientSession, mock_stdio_client, mock_mcp_available, aider_bridge_instance):
    ...
    @patch('src.aider_bridge.bridge.stdio_client', spec=real_stdio_client)
    @patch('src.aider_bridge.bridge.ClientSession', spec=RealClientSession)
    async def test_call_aider_tool_list_models_success(self, MockClientSession, mock_stdio_client, mock_mcp_available, aider_bridge_instance):
    ...
    @patch('src.aider_bridge.bridge.stdio_client', spec=real_stdio_client)
    @patch('src.aider_bridge.bridge.ClientSession', spec=RealClientSession)
    async def test_call_aider_tool_mcp_exception(self, MockClientSession, mock_stdio_client, mock_mcp_available, aider_bridge_instance):
    ...
    @patch('src.aider_bridge.bridge.stdio_client', spec=real_stdio_client)
    @patch('src.aider_bridge.bridge.ClientSession', spec=RealClientSession)
    async def test_call_aider_tool_json_parse_error(self, MockClientSession, mock_stdio_client, mock_mcp_available, aider_bridge_instance):
